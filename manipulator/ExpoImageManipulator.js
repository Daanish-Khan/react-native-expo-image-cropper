...
class ExpoImageManipulator extends Component {
    ...
    getCropBounds = (actualWidth, actualHeight) => {
        ...
        this.selectionRect.x = intersectAreaObj.originX;
        this.selectionRect.y = intersectAreaObj.originY;
        this.selectionRect.width = intersectAreaObj.width;
        this.selectionRect.height = intersectAreaObj.height;
                ...
                <Modal
                    ...
                    <View style={{ flex: 1, backgroundColor: 'black' , width: Dimensions.get('window').width }}>
                        <ScrollView
                            ...
                            contentContainerStyle={{backgroundColor: 'black', justifyContent: "center", alignItems: "center", flexGrow: 1}}
                            maximumZoomScale={5}
